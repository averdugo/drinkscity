							...
							<tbody>
								@foreach ($stores as $store)
									<tr class="even pointer">
										...
										@if ($store->status == 1)
											<td data-id="{{ $store->id }}">
												<button type="button" title="Ver Tienda" class="btn btn-default seeStores"><i class="fa fa-eye"></i></button>
										...
										@else
											<td data-id="{{ $store->id }}">
												<button type="button" title="Ver Tienda" class="btn btn-default seeStores"><i class="fa fa-eye"></i></button>
												<button type="button" title="Cambiar Estado" class="btn btn-default acceptStore"><i class="fa fa-check"></i></button>
												<button type="button" title="Eliminar Producto" class="btn btn-default deleteStore"><i class="fa fa-minus"></i></button>
											</td>
										@endif
									</tr>
