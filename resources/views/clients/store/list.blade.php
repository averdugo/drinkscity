							...
							<tbody>
								@foreach ($stores as $store)
									<tr class="even pointer">
										...
										<td data-id="{{ $store->id }}">
											<button type="button" title="Ver Productos" class="btn btn-default"><i class="fa fa-shopping-cart"></i></button>
											<a href="/stores/{{ $store->id }}/edit" title="Editar Tienda" class="btn btn-default "><i class="fa fa-pencil"></i></a>
